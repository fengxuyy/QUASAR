...
def initialize_rag_from_directory(directory_path: Optional[str] = None) -> str:
    """Initialize or reindex the RAG system with ASE, pymatgen, MACE, RASPA3, Quantum ESPRESSO, LAMMPS, and RDKit documentation.
    ...
    from ..rag import get_vectorstore, initialize_rag
    ...
    if vs:
        ...
        return "Error: Failed to initialize RAG system. Check that the directory path is correct and contains ASE, pymatgen, MACE, RASPA3, Quantum ESPRESSO, LAMMPS, or RDKit files."


@tool
def query_rag(query: str, library: str, top_k: int = 3) -> str:
    """Query the RAG system for ASE, pymatgen, MACE, RASPA3, Quantum ESPRESSO, LAMMPS, and RDKit-related information.
    
    This is your exclusive source of information for ASE, pymatgen, MACE, RASPA3, Quantum ESPRESSO, LAMMPS, and RDKit API usage.
    Always query RAG before writing any code using these libraries.
    
    Args:
        query: The search query about ASE, pymatgen, MACE, RASPA3, Quantum ESPRESSO, LAMMPS, or RDKit functionality
        library: Library name to filter by. Valid values: "raspa3", "qe", "mace", "pymatgen", "ase", "lammps", "rdkit"
        top_k: Number of results to return (default: 3)
    
    Returns:
        Retrieved documentation snippets and code examples
    """
    from ..rag import query_rag as _query_rag
